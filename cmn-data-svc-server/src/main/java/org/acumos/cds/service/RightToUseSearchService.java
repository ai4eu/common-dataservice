...
public interface RightToUseSearchService {
	 ...
	 * @param site
	 *                       For-all site flag; ignored if null
	 * @param isOr
	 ...
	 */
	Page<MLPRightToUse> findRtus(String solutionId, Boolean site, boolean isOr, Pageable pageable);
