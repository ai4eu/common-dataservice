...
public interface SolutionValidationRepository
	 ...
	 */
	Iterable<MLPSolutionValidation> findBySolutionIdAndRevisionId(@Param("solutionId") String solutionId,
	...
	void deleteBySolutionIdAndRevisionId(@Param("solutionId") String solutionId,
			@Param("revisionId") String revisionId);
